                ...
                >
                  ...
                  <div className="flex flex-col space-y-2">
                    <div
                      ...
                      className="flex space-x-3 items-center bg-orange text-white px-4 py-1 rounded-full text-base hover:shadow-md focus:ring-2 focus:ring-offset-2 focus:ring-orange cursor-pointer"
                    >
